...
public class exoplayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("urlllllllllllllllllllllll", url);
if  (isYouTubeLink(url)){
    ...
    private boolean isYouTubeLink(String videoId) {
        // Implement your logic to check if the videoId is a YouTube link
        // For example, you could check if it starts with "https://www.youtube.com/"
        return videoId.startsWith("https://www.youtube.com/") || videoId.startsWith("http://www.youtube.com/");
    }
